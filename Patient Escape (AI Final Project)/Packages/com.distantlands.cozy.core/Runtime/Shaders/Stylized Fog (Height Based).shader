	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_142_0_g127 = lerpResult113_g132;
				float3 hsvTorgb32_g127 = RGBToHSV( temp_output_142_0_g127.rgb );
				float3 temp_output_91_0_g127 = WorldPosition;
				...
				float temp_output_26_0_g127 = ( (temp_output_142_0_g127).a * saturate( temp_output_15_0_g127 ) );
				...
				float3 hsvTorgb2_g130 = RGBToHSV( ( temp_output_142_0_g127 + ( hsvTorgb32_g127.z * saturate( ( temp_output_26_0_g127 * MoonMask47_g127 ) ) * CZY_FogMoonFlareColor ) ).rgb );
				...
				float temp_output_75_0_g127 = ( finalAlpha141_g127 * saturate( ( ( 1.0 - saturate( ( ( ( direction90_g127.y * 0.1 ) * ( 1.0 / ( ( CZY_FogSmoothness * length( ase_objectScale ) ) * 10.0 ) ) ) + ( 1.0 - CZY_FogOffset ) ) ) ) * CZY_FogIntensity ) ) );
				float temp_output_124_56_g122 = temp_output_75_0_g127;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 temp_output_91_0_g127 = ase_worldPos;
				float3 direction90_g127 = ( temp_output_91_0_g127 - _WorldSpaceCameraPos );
				float3 ase_objectScale = float3( length( GetObjectToWorldMatrix()[ 0 ].xyz ), length( GetObjectToWorldMatrix()[ 1 ].xyz ), length( GetObjectToWorldMatrix()[ 2 ].xyz ) );
				float temp_output_75_0_g127 = ( finalAlpha141_g127 * saturate( ( ( 1.0 - saturate( ( ( ( direction90_g127.y * 0.1 ) * ( 1.0 / ( ( CZY_FogSmoothness * length( ase_objectScale ) ) * 10.0 ) ) ) + ( 1.0 - CZY_FogOffset ) ) ) ) * CZY_FogIntensity ) ) );
				float temp_output_124_56_g122 = temp_output_75_0_g127;
...
ASEEND*/
//CHKSM=29F4D25FCB1FF8764446F8D279ACB160991B4C93